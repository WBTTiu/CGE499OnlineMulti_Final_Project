...
public class FirstPersonController : NetworkBehaviour
{
    ...
    {
        // base.OnNetworkSpawn();
        CinemachineVirtualCamera cm = MyCamera.GetComponentInChildren<CinemachineVirtualCamera>();
        FirstPersonController[] firstPersonController = FindObjectsOfType<FirstPersonController>();
        if (IsOwner && firstPersonController.Length == 1)
        {
            cm.Priority = 1;
            print("IsOwner");
        }
